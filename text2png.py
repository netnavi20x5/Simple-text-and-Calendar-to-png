...
parser = argparse.ArgumentParser(
    description="Convert text file to a receipt-size PNG (5cm wide) with optional checklist formatting"
)
...
# MEASURE & WRAP TEXT
# ==============================
temp_img = Image.new("L", (WIDTH_PX, 1000), 255)
...
# Deduct checkbox spacing only if we are creating a checklist
...
for item_lines in structured_items:
    if args.checklist:
        # Checklist Layout: Elements are grouped together alongside the checkbox
        ...
        # Standard Layout: Lines wrap normally and align independently
